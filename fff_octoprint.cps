...
FFF posts processor with upload to OctopPint.
...
description = "Generic FFF Octoprint";
vendor = "Guffy1234";
vendorUrl = "https://github.com/guffy1234/fff_octoprint_posts_processor";
certificationLevel = 2;
minimumRevision = 45633;

longDescription = "Simple post to export toolpath for generic FFF Machine in gcode format and send to OctoPrint";
